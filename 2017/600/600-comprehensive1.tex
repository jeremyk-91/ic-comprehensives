...
\begin{enumerate}
\item Travis worked a part-time job as an undergraduate teaching assistant. He taught several first-year students various formal proof techniques. For example,

%TODO Some reasoning like proof.
[6 marks]

\item Russell worked a part-time job at a quantitative finance company. He

%TODO Basic QF question.
[6 marks]

\item Joel worked a part-time job as a software engineer. The spring term has $11$ weeks, and he would work one day every week. With probability $p$, the work day would be uneventful and he would work a number of hours distributed according to $U(8, 13)$; with probability $1 - p$, a high-priority ticket would arrive and he would work a number of hours distributed according to $U(12, 15)$. $p$ itself is distributed according to $U(a, b)$ with $0 \leq a \leq b \leq 1$. The number of hours Joel worked each week can be assumed conditionally independent given a value of $p$. Let $T$ be the total number of hours Joel worked during the spring term.
\\[12pt]
